...
import { $ as UnsupportedImageConversion, A as MissingImageDimension, H as RemoteImageNotAllowed, P as NoImageMetadata, T as LocalImageUsedWrongly, b as IncompatibleDescriptorOptions, c as ExpectedImage, d as FailedToFetchRemoteImageDimensions, et as UnsupportedImageFormat, l as ExpectedImageOptions, t as AstroError, u as ExpectedNotESMImage, w as InvalidImageService } from "./errors_CgRXx5Vk.mjs";
import { a as VALID_SUPPORTED_FORMATS, i as DEFAULT_OUTPUT_FORMAT, r as DEFAULT_HASH_PROPS } from "./_astro_content_BiKg38K5.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_IjQO2C7d.mjs").catch((e) => {
...
//#endregion
export { inferRemoteSize as a, isESMImportedImage as c, parseQuality as i, isRemoteImage as l, getImage as n, detector as o, baseService as r, resolveDefaultOutputFormat as s, getConfiguredImageService as t, resolveSrc as u };
