...
import { Q as UnknownContentCollectionError, U as RenderUndefinedEntryError, t as AstroError } from "./errors_CgRXx5Vk.mjs";
import { S as unescapeHTML, T as createComponent, b as createHeadAndContent, f as renderTemplate, h as generateCspDigest, n as renderScriptElement, o as renderComponent, r as renderUniqueStylesheet, t as spreadAttributes } from "./server_BB1eRw9J.mjs";
...
var ImmutableDataStore = class ImmutableDataStore {
	...
	*/
	static async fromModule() {
		try {
			const data = await import("./_astro_data-layer-content_CImgDXV2.mjs");
...
async function updateImageReferencesInBody(html, fileName) {
	...
	const { getImage } = await import("./_virtual_astro_get-image_kySqyVTW.mjs");
...
//#endregion
export { VALID_SUPPORTED_FORMATS as a, DEFAULT_OUTPUT_FORMAT as i, renderEntry as n, DEFAULT_HASH_PROPS as r, getCollection as t };
